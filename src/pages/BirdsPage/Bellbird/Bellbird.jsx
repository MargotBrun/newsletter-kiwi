...
export default ({ handleOpenPopup }) => (
  <div className="card">
    <button type="button" className="BirdsPage_button" onClick={handleOpenPopup('wfifZO49bSM')}>
      <img src={bellbirdImg} className="card-img-top" alt="Korimako (Bellbird)" />
    ...
    <div className="card-footer BirdsPage_footer">
      <ShinyLink multicolor onClick={handleOpenPopup('wfifZO49bSM')}>
